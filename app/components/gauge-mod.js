...
export default Ember.Component.extend({
    ...
    findTheDamnModel: function() {
        console.log(this.model.get('totalSteps'));
    }.on('didInsertElement'),
    showGraph: function() {
        var arc1, arc2, barWidth, chart, chartInset, degToRad, el, repaintGauge, arcEndRad,
            height, margin, numSections, padRad, percToDeg, percToRad, needle, arcStartRad,
            percent, radius, sectionIndx, sectionPerc, svg, totalPercent, width;
